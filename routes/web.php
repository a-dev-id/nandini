...
Route::resource('/', App\Http\Controllers\Nandini\HomeController::class);
Route::resource('/suites-villas', App\Http\Controllers\Nandini\SuiteVillaController::class);
Route::resource('/experiences', App\Http\Controllers\Nandini\ExperienceController::class);
Route::resource('/dining', App\Http\Controllers\Nandini\DiningController::class);
Route::resource('/spa', App\Http\Controllers\Nandini\SpaController::class);
...
Route::middleware(['auth', 'verified'])->prefix('panel/admin')->group(function () {
    ...
    Route::resource('home-text-slider', App\Http\Controllers\Admin\HomeTextSliderController::class);
